...
def main():
    ...
    # Yedekleme işlemini belirli aralıklarla başlatan thread'i başlatıyoruz
    backup_thread_instance = Thread(target=periodic_backup, args=(source_dir, backup_dir, backup_interval))
    backup_thread_instance.daemon = True  # Thread'in programla birlikte kapanmasını sağla
